...
const SettingsScreen: React.FC<SettingsScreenProps> = ({ onLogout, onToggleTheme, theme, isGuest }) => {
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto animate-fadeIn">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/50 rounded-xl p-4 shadow-md">
          ...
          {isGuest ? (
            <p className="text-sm text-slate-500 dark:text-gray-400">You are currently using Vmind as a guest. Sign up to sync your data across devices.</p>
          ) : (
            <div className="flex items-center justify-between">
              <p className="text-sm text-slate-500 dark:text-gray-400">You are logged in.</p>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/50 rounded-xl p-4 shadow-md">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-slate-500 dark:text-gray-400">Theme</p>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/50 rounded-xl p-4 shadow-md opacity-50">
          ...
          <p className="text-sm text-slate-500 dark:text-gray-400 mb-4">Backup and restore your data. (Coming Soon)</p>
