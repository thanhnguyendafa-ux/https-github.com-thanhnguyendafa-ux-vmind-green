...
const icons: { [key: string]: React.ReactNode } = {
  ...
  'youtube': <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />,
  'headphones': <path fillRule="evenodd" d="M12 2.25c-5.11 0-9.25 4.14-9.25 9.25v.75a.75.75 0 0 0 .75.75H4.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 0 .75.75h.75a3 3 0 0 1 3 3v1.5a.75.75 0 0 0 .75.75h.75a.75.75 0 0 0 .75-.75v-1.5a3 3 0 0 1 3-3h.75a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 0 .75.75H20.25a.75.75 0 0 0 .75-.75v-.75c0-5.11-4.14-9.25-9.25-9.25Z" clipRule="evenodd" />,
  'stack-of-cards': <path fillRule="evenodd" d="M2.25 5.25a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3v10.5a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V5.25ZM6 6.75A.75.75 0 0 1 6.75 6h10.5a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-.75.75H6.75a.75.75 0 0 1-.75-.75v-7.5ZM.75 7.5a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3v10.5a3 3 0 0 1-3 3H3.75a3 3 0 0 1-3-3V7.5Z" clipRule="evenodd" />,
  'puzzle-piece': <path fillRule="evenodd" d="M11.25 2.25a.75.75 0 0 0-1.5 0v2.646a2.25 2.25 0 0 1-3.996 1.858L3.63 4.63a.75.75 0 0 0-1.26.52v2.214a.75.75 0 0 0 .52 1.26l2.122 2.121a2.25 2.25 0 0 1-1.858 3.996H2.25a.75.75 0 0 0 0 1.5h2.646a2.25 2.25 0 0 1 1.858 3.996l-2.122 2.121a.75.75 0 0 0-.52 1.26v2.214a.75.75 0 0 0 1.26.52l2.121-2.121a2.25 2.25 0 0 1 3.996 1.858v2.646a.75.75 0 0 0 1.5 0v-2.646a2.25 2.25 0 0 1 3.996-1.858l2.122 2.121a.75.75 0 0 0 1.26-.52v-2.214a.75.75 0 0 0-.52-1.26l-2.122-2.121a2.25 2.25 0 0 1 1.858-3.996H21.75a.75.75 0 0 0 0-1.5h-2.646a2.25 2.25 0 0 1-1.858-3.996l2.122-2.121a.75.75 0 0 0 .52-1.26V5.15a.75.75 0 0 0-1.26-.52l-2.121 2.121A2.25 2.25 0 0 1 15 4.896V2.25Z" clipRule="evenodd" />,
  'film': <path fillRule="evenodd" d="M2.25 4.5A2.25 2.25 0 0 1 4.5 2.25h15A2.25 2.25 0 0 1 21.75 4.5v15a2.25 2.25 0 0 1-2.25 2.25h-15A2.25 2.25 0 0 1 2.25 19.5v-15ZM4.5 6a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75V6Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75V6Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75V6Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75V6Zm-9 6a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm-9 6a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Zm3 0a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1-.75-.75v-.75Z" clipRule="evenodd" />,
};

const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  const iconNode = icons[name];
  // A simple way to check for solid icons is to see if their path includes a fillRule.
  // FIX: Cast props to a known shape to fix "Property 'fillRule' does not exist on type 'unknown'" error in strict mode.
  const isSolid = iconNode && React.isValidElement(iconNode) && (iconNode.props as { fillRule?: string }).fillRule;
